        ...
        <div class="panel panel-default">  
            ...
            <div class="col-sm-10">
              <input type="text"  name="id_user" class="form-control" id="nama" placeholder="" required="">
            </div>
          </div>
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-10">
              <input type="text"  name="type" class="form-control" id="alamat" placeholder="" required="">
            </div>
          </div>
